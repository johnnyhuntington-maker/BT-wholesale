...
const INIT_ORGS=[
  ...
  {id:'riverside',name:'Riverside Comms',typeKey:'subReseller',parentId:'northgate',contact:'hello@riverside-comms.co.uk',primaryName:'Dan Osei',primaryEmail:'dan.osei@riverside-comms.co.uk',primaryPhone:'+44 117 890 1234',billingName:'Dan Osei',billingEmail:'billing@riverside-comms.co.uk',billingPhone:'+44 117 890 1235',address:'Unit 3, Riverside Business Park, Bath, BA1 1RW',website:'www.riverside-comms.co.uk',entitlements:['broadband','digitalVoice','kci','support','branding']},
  {id:'apex',name:'Apex Telecom',typeKey:'dealer',parentId:'northgate',contact:'sales@apextelecom.co.uk',primaryName:'Fatima Al-Rashid',primaryEmail:'fatima.alrashid@apextelecom.co.uk',primaryPhone:'+44 1908 123 456',billingName:'Accounts Dept',billingEmail:'accounts@apextelecom.co.uk',billingPhone:'+44 1908 123 457',address:'12 Apex Way, Northampton, NN1 2BP',website:'www.apextelecom.co.uk',entitlements:['broadband','digitalVoice','kci','branding']},
];
const INIT_USERS=[
            ...
            return h('div',{style:{maxWidth:'1120px',display:'flex',height:'calc(100vh - 140px)',border:'1px solid #E3E3E3',borderRadius:'16px',overflow:'hidden',background:'#fff'}},
              ...
              dSel
                ?h('div',{style:{flex:1,overflowY:'auto',padding:'28px',minWidth:0}},
                    ...
                    h('div',{style:{display:'flex',alignItems:'center',justifyContent:'space-between',marginBottom:'14px',gap:'12px',flexWrap:'wrap'}},
                      h('div',{style:{fontSize:'11px',fontWeight:700,letterSpacing:'0.07em',textTransform:'uppercase',color:'#434343'}},'Entitlements'),
                      h('div',{style:{display:'flex',gap:'6px',flexWrap:'wrap'}},
                        h('span',{style:{display:'inline-flex',alignItems:'center',gap:'5px',fontSize:'11.5px',color:'#2A6E30',fontWeight:600,background:'#E8F5E9',padding:'4px 10px',borderRadius:'999px',border:'1px solid #C3E6C5'}},
                          h('span',{style:{width:'7px',height:'7px',borderRadius:'50%',background:'#357E3C',display:'inline-block',flexShrink:0}}),
                          'Granted'),
                        h('span',{style:{display:'inline-flex',alignItems:'center',gap:'5px',fontSize:'11.5px',color:'#8B5C00',fontWeight:600,background:'#FFF3CD',padding:'4px 10px',borderRadius:'999px',border:'1px solid #F5DFA0'}},
                          h('span',{style:{width:'7px',height:'7px',borderRadius:'50%',background:'#D88C00',display:'inline-block',flexShrink:0}}),
                          'Available'),
                        h('span',{style:{display:'inline-flex',alignItems:'center',gap:'5px',fontSize:'11.5px',color:'#888888',fontWeight:600,background:'#F2F2F2',padding:'4px 10px',borderRadius:'999px',border:'1px solid #E0E0E0'}},
                          h('span',{style:{width:'7px',height:'7px',borderRadius:'50%',background:'#CCCCCC',display:'inline-block',flexShrink:0}}),
                          'Not in parent'))),
